    def compute_reward(self):
        ...
        orientation_reward = -0.3 * orientation_error
        ...
        # Penalty for DOF limit violations; lowering its weight to avoid excessive penalties
        ...
        # Penalty for high torques to encourage energy efficiency; further reduction in weight
